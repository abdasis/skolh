    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white font-[Plus_Jakarta_Sans] text-gray-900 dark:bg-gray-950 dark:text-gray-100">
                    ...
                    <div className="bg-emerald-800 dark:bg-emerald-950">
                        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
                            ...
                            <div className="flex items-center gap-1">
                                {/* Facebook */}
                                <a href="#" className="flex h-7 w-7 items-center justify-center rounded text-white/80 transition hover:bg-white/10 hover:text-white">
                    ...
                    <nav className="border-b border-gray-100 bg-white/95 shadow-sm backdrop-blur-lg dark:border-gray-800 dark:bg-gray-950/95">
                        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-base font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">SDIT Al-Aziz</h1>
                                    <p className="text-[10px] font-medium text-gray-500 dark:text-gray-400">Sekolah Dasar Islam Terpadu</p>
                                </div>
                            </div>

                            {/* Desktop Nav Links */}
                            <div className="hidden items-center gap-1 md:flex">
                                <a href="#beranda" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-emerald-400">
                                    Beranda
                                </a>
                                <a href="#tentang" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-emerald-400">
                                    Tentang
                                </a>
                                <a href="#program" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-emerald-400">
                                    Program
                                </a>
                                <a href="#fasilitas" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-emerald-400">
                                    Fasilitas
                                </a>
                                <a href="#berita" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-emerald-400">
                                    Berita
                                </a>
                                <a href="#kontak" className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-emerald-400">
                                    Kontak
                                </a>
                            </div>
                            ...
                            <div className="hidden items-center gap-3 md:flex">
                                {auth.user ? (
                                    <Link
                                        href={dashboard()}
                                        className="rounded-lg bg-emerald-600 px-6 py-2.5 text-sm font-bold uppercase tracking-wide text-white shadow-sm transition hover:bg-emerald-700"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                                    <>
                                        {canRegister && (
                                            <Link
                                                href={register()}
                                                className="rounded-lg bg-orange-500 px-6 py-2.5 text-sm font-bold uppercase tracking-wide text-white shadow-sm transition hover:bg-orange-600"
                                            >
                                                Daftar Sekarang
                                            </Link>
                                        )}
                        ...
                        {mobileMenuOpen && (
                            <div className="border-t border-gray-100 bg-white px-4 py-4 md:hidden dark:border-gray-800 dark:bg-gray-950">
                                <div className="flex flex-col gap-1">
                                    <a href="#beranda" className="rounded-lg px-3 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800">Beranda</a>
                                    <a href="#tentang" className="rounded-lg px-3 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800">Tentang</a>
                                    <a href="#program" className="rounded-lg px-3 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800">Program</a>
                                    <a href="#fasilitas" className="rounded-lg px-3 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800">Fasilitas</a>
                                    <a href="#berita" className="rounded-lg px-3 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800">Berita</a>
                                    <a href="#kontak" className="rounded-lg px-3 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:text-emerald-600 dark:text-gray-300 dark:hover:bg-gray-800">Kontak</a>
                                    <div className="mt-3 flex flex-col gap-2 border-t border-gray-100 pt-4 dark:border-gray-800">
                                        {auth.user ? (
                                            <Link href={dashboard()} className="rounded-lg bg-emerald-600 py-3 text-center text-sm font-bold uppercase tracking-wide text-white">
                                                Dashboard
                                            </Link>
                                        ) : (
                                            <>
                                                {canRegister && (
                                                    <Link href={register()} className="rounded-lg bg-orange-500 py-3 text-center text-sm font-bold uppercase tracking-wide text-white">
                                                        Daftar Sekarang
                                                    </Link>
                                                )}
                                                <Link href={login()} className="rounded-lg border-2 border-emerald-600 py-2.5 text-center text-sm font-bold text-emerald-600">
                                                    Masuk
                                                </Link>
                                            </>
                                        )}
                ...
                {/* Hero Section */}
                <section id="beranda" className="relative mt-[calc(1.75rem+3.75rem)] min-h-[560px] overflow-hidden sm:min-h-[600px] lg:min-h-[640px]">
                    {/* Background image */}
                    <div
                        ...
                        <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-8 px-6 py-20 sm:px-8 lg:grid-cols-2 lg:px-12">
                            ...
                            <div>
                                ...
                                <p className="mt-5 max-w-md text-sm leading-relaxed text-white/75 sm:text-base">
                                    SDIT Al-Aziz memadukan kurikulum nasional dengan nilai-nilai keislaman
                                    untuk membentuk generasi yang cerdas, berkarakter, dan berakhlak mulia.
                                </p>

                                <div className="mt-8 flex flex-wrap gap-3">
                                    <a
                                        href="#kontak"
                                        className="rounded-lg bg-orange-500 px-7 py-3 text-sm font-bold uppercase tracking-wide text-white shadow-sm transition hover:bg-orange-600"
                                    >
                                        Daftar Sekarang
                                    </a>
                                    <a
                                        href="#program"
                                        className="rounded-lg bg-emerald-800 px-7 py-3 text-sm font-bold uppercase tracking-wide text-white shadow-sm transition hover:bg-emerald-900"
                                    >
                                        Program Kami
                                    </a>
                                </div>
                            ...
                            <div className="hidden items-center justify-end lg:flex">
                                <div className="relative pb-6">
                                    ...
                                    />
                                    {/* Badge */}
                                    <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-white px-5 py-2 text-xs font-bold text-emerald-800 shadow-sm">
                        ...
                        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
                            <div>
                                ...
                                <p className="mt-6 text-base leading-relaxed text-gray-600 dark:text-gray-400">
                                    SDIT Al-Aziz adalah sekolah dasar Islam terpadu yang berkomitmen untuk memberikan pendidikan
                                    holistik kepada setiap siswa. Kami memadukan kurikulum nasional dengan kurikulum keislaman
                                    yang komprehensif, sehingga siswa tidak hanya unggul dalam akademik tetapi juga memiliki
                                    fondasi keimanan dan akhlak yang kuat.
                                </p>
                                <p className="mt-4 text-base leading-relaxed text-gray-600 dark:text-gray-400">
                                    Dengan tenaga pendidik yang profesional dan berpengalaman, kami menciptakan lingkungan
                                    belajar yang kondusif, menyenangkan, dan penuh kasih sayang.
                                </p>

                                <div className="mt-8 grid grid-cols-2 gap-4">
                                    {[
                                        { icon: BookIcon, title: 'Kurikulum Terpadu', desc: 'Kurikulum nasional terintegrasi keislaman' },
                                        { icon: HeartIcon, title: 'Pembinaan Akhlak', desc: 'Pembiasaan ibadah dan akhlak mulia' },
                                        { icon: StarIcon, title: 'Prestasi Gemilang', desc: 'Meraih prestasi di berbagai kompetisi' },
                                        { icon: UsersIcon, title: 'Guru Profesional', desc: 'Tenaga pendidik bersertifikasi' },
                                    ].map((item) => (
                                        <div key={item.title} className="rounded-xl border border-gray-100 p-4 dark:border-gray-800">
                                            <item.icon className="h-8 w-8 text-emerald-600 dark:text-emerald-400" />
                                            <h3 className="mt-3 text-sm font-semibold text-gray-900 dark:text-white">{item.title}</h3>
                            ...
                            <div className="relative">
                                <div className="aspect-[4/3] overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30">
                                    <div className="flex h-full flex-col items-center justify-center p-8 text-center">
                                        ...
                                        <h3 className="mt-4 text-xl font-bold text-gray-900 dark:text-white">Visi Kami</h3>
                                        <p className="mt-3 max-w-sm text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                                            "Menjadi lembaga pendidikan Islam terpadu yang unggul dalam membentuk generasi
                                            Qurani, berilmu, berakhlak mulia, dan berprestasi."
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mx-auto mt-4 max-w-2xl text-base text-gray-600 dark:text-gray-400">
                                Program pendidikan yang dirancang untuk mengembangkan potensi siswa secara menyeluruh.
                            </p>
                        </div>
                        ...
                        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {[
                                ...
                                const palette: Record<string, { gradient: string; iconBg: string; iconText: string; tagBg: string; tagText: string; numText: string; line: string; arrow: string }> = {
                                    emerald: {
                                    ...
                                    teal: {
                                        gradient: 'from-teal-500/10 via-transparent to-transparent dark:from-teal-500/15',
                                    ...
                                    orange: {
                                        gradient: 'from-orange-500/10 via-transparent to-transparent dark:from-orange-500/15',
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className={`pointer-events-none absolute right-4 top-3 select-none text-7xl font-black leading-none ${p.numText} transition duration-300 group-hover:opacity-60`}>
                                            {program.num}
                                        </span>

                                        <div className="relative flex flex-1 flex-col p-6">
                                            {/* Tag */}
                                            <span className={`inline-flex w-fit items-center rounded-full px-2.5 py-0.5 text-[11px] font-semibold tracking-wide ${p.tagBg} ${p.tagText}`}>
                                                {program.tag}
                                            </span>

                                            {/* Icon */}
                                            <div className={`mt-5 inline-flex rounded-xl p-3 ${p.iconBg} w-fit shadow-sm`}>
                                                <program.icon className={`h-6 w-6 ${p.iconText}`} />
                                            </div>

                                            {/* Title */}
                                            <h3 className="mt-4 text-lg font-bold leading-snug text-gray-900 dark:text-white">
                                                {program.title}
                                            </h3>
                                            ...
                                            <div className="mt-6 flex items-center gap-1.5 border-t border-gray-100 pt-4 dark:border-gray-800">
                                                ...
                                                <svg className={`h-3.5 w-3.5 ${p.arrow} transition-transform duration-200 group-hover:translate-x-1`} fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                ...
                <section id="fasilitas" className="relative overflow-hidden py-24 sm:py-32">
                    ...
                    <div className="absolute right-1/4 bottom-0 h-72 w-72 rounded-full bg-orange-500/10 blur-3xl" />
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="text-center">
                            ...
                            <p className="mx-auto mt-4 max-w-xl text-base text-white/75">
                                Fasilitas lengkap dan modern untuk mendukung proses belajar mengajar yang optimal.
                            </p>
                        </div>
                        ...
                        <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                            {[
                                { name: 'Ruang Kelas Ber-AC', desc: 'Kelas nyaman & kondusif', icon: ClassroomIcon },
                                { name: 'Lab Komputer', desc: 'Teknologi terkini', icon: ComputerIcon },
                                { name: 'Perpustakaan', desc: 'Ribuan koleksi buku', icon: LibraryIcon },
                                { name: 'Masjid', desc: 'Sarana ibadah lengkap', icon: MosqueIcon },
                                { name: 'Lapangan Olahraga', desc: 'Area bermain & olahraga', icon: SportIcon },
                                { name: 'Kantin Sehat', desc: 'Menu halal & bergizi', icon: FoodIcon },
                                { name: 'UKS', desc: 'Kesehatan siswa terjaga', icon: HealthIcon },
                                { name: 'Taman Bermain', desc: 'Ruang kreativitas anak', icon: PlaygroundIcon },
                            ].map((facility) => (
                                <div
                                    key={facility.name}
                                    className="group relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-sm transition duration-300 hover:border-emerald-500/50 hover:bg-white/15"
                                >
                                    {/* Hover glow */}
                                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-emerald-500/0 to-emerald-500/0 transition duration-300 group-hover:from-emerald-500/5 group-hover:to-transparent" />

                                    <div className="relative">
                                        {/* Icon */}
                                        <div className="inline-flex rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-3">
                                            <facility.icon className="h-6 w-6 text-emerald-400" />
                                        </div>

                                        <h3 className="mt-4 text-sm font-bold text-white">{facility.name}</h3>
                                        <p className="mt-1 text-xs text-white/65">{facility.desc}</p>

                                        {/* Bottom accent line */}
                                        <div className="mt-4 h-px w-0 bg-gradient-to-r from-emerald-500 to-transparent transition-all duration-300 group-hover:w-full" />
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <section id="berita" className="bg-gray-50 py-20 sm:py-28 dark:bg-gray-900/50">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
                            <div>
                                ...
                                <p className="mt-4 max-w-xl text-base text-gray-600 dark:text-gray-400">
                                    Ikuti perkembangan terkini tentang kegiatan dan prestasi SDIT Al-Aziz.
                                </p>
                            </div>
                            <a
                                href="#"
                        ...
                        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <article className="group flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-600/5 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-emerald-800">
                                <div className="relative overflow-hidden">
                                    <div className="aspect-[16/9] bg-gradient-to-br from-emerald-600 to-teal-700">
                                        <div className="flex h-full items-center justify-center p-8">
                                            <svg className="h-16 w-16 text-white/30" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor">
                                ...
                                <div className="flex flex-1 flex-col p-6">
                                    ...
                                    <h3 className="mt-3 text-base font-bold leading-snug text-gray-900 transition group-hover:text-emerald-700 dark:text-white dark:group-hover:text-emerald-400">
                                        Siswa SDIT Al-Aziz Raih Juara 1 Olimpiade Matematika Tingkat Nasional
                                    </h3>
                                    <p className="mt-2 flex-1 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                                        Kebanggaan bagi seluruh keluarga besar SDIT Al-Aziz. Ahmad Fauzi, siswa kelas 5,
                                        berhasil meraih juara pertama dalam kompetisi bergengsi tersebut.
                                    </p>
                                    <div className="mt-5 flex items-center justify-between border-t border-gray-100 pt-4 dark:border-gray-800">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs font-medium text-gray-700 dark:text-gray-300">Redaksi Al-Aziz</span>
                                        </div>
                                        <a href="#" className="flex items-center gap-1 text-xs font-semibold text-emerald-600 transition hover:text-emerald-700 dark:text-emerald-400">
                                            Baca selengkapnya
                            ...
                            <article className="group flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-600/5 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-emerald-800">
                                ...
                                <div className="flex flex-1 flex-col p-6">
                                    ...
                                    <h3 className="mt-3 text-base font-bold leading-snug text-gray-900 transition group-hover:text-emerald-700 dark:text-white dark:group-hover:text-emerald-400">
                                        Kunjungan Edukatif ke Museum Nasional: Belajar Sejarah Langsung di Lapangan
                                    </h3>
                                    <p className="mt-2 flex-1 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                                        Ratusan siswa kelas 4, 5, dan 6 mengikuti kunjungan edukatif ke Museum Nasional
                                        sebagai bagian dari program pembelajaran berbasis pengalaman nyata.
                                    </p>
                                    <div className="mt-5 flex items-center justify-between border-t border-gray-100 pt-4 dark:border-gray-800">
                                        <div className="flex items-center gap-2">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-100 text-[10px] font-bold text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400">
                            ...
                            <article className="group flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-600/5 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-emerald-800">
                                ...
                                <div className="flex flex-1 flex-col p-6">
                                    ...
                                    <h3 className="mt-3 text-base font-bold leading-snug text-gray-900 transition group-hover:text-emerald-700 dark:text-white dark:group-hover:text-emerald-400">
                                        Pendaftaran Peserta Didik Baru Tahun Ajaran 2026/2027 Resmi Dibuka
                                    </h3>
                                    <p className="mt-2 flex-1 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                                        SDIT Al-Aziz membuka pendaftaran peserta didik baru untuk tahun ajaran 2026/2027.
                                        Kuota terbatas, segera daftarkan putra-putri Anda sebelum 30 April 2026.
                                    </p>
                                    <div className="mt-5 flex items-center justify-between border-t border-gray-100 pt-4 dark:border-gray-800">
                                        <div className="flex items-center gap-2">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-100 text-[10px] font-bold text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400">
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="text-center">
                            ...
                            <h2 className="mt-5 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl dark:text-white">
                                Apa Kata{' '}
                                <span className="text-emerald-600 dark:text-emerald-400">Wali Murid</span>
                            </h2>
                            <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-gray-600 dark:text-gray-400">
                                Kepercayaan orang tua adalah amanah terbesar kami. Simak pengalaman mereka bersama SDIT Al-Aziz.
                            </p>
                        </div>
                        ...
                        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {[
                                ...
                                <div
                                    key={item.name}
                                    className="group relative flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl hover:shadow-emerald-600/5 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-emerald-800"
                                >
                                    {/* Top accent bar */}
                                    ...
                                    <div className="flex flex-1 flex-col p-6">
                                        ...
                                        {/* Quote mark */}
                                        <svg className="mt-4 h-8 w-8 text-emerald-100 dark:text-emerald-900/50" fill="currentColor" viewBox="0 0 32 32">
                        ...
                        {/* Bottom CTA banner */}
                        <div className="mt-16 relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-700 px-8 py-10 sm:px-12">
                            ...
                            <div className="relative flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
                                <div>
                                    <h3 className="text-lg font-bold text-white sm:text-xl">Daftarkan Putra-Putri Anda Sekarang</h3>
                                    <p className="mt-1 text-sm text-emerald-100">
                                        Bergabung bersama ratusan keluarga yang sudah mempercayakan pendidikan terbaik anak mereka.
                                    </p>
                                </div>
                                <a
                                    href="#kontak"
                                    className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-white px-7 py-3 text-sm font-bold text-emerald-700 shadow-sm transition hover:bg-emerald-50"
                                >
                                    Hubungi Kami
                ...
                {/* Kontak */}
                <section id="kontak" className="bg-gray-50 py-20 sm:py-28 dark:bg-gray-900/50">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="grid gap-12 lg:grid-cols-2">
                            <div>
                                ...
                                <div className="mt-8 space-y-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Alamat</h3>
                                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                                Jl. Pendidikan No. 1, Kelurahan Contoh,<br />
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Telepon</h3>
                                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">(021) 1234-5678</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">info@sditalaziz.sch.id</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Jam Operasional</h3>
                                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <div className="rounded-2xl border border-gray-100 bg-white p-8 dark:border-gray-800 dark:bg-gray-900">
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Kirim Pesan</h3>
                                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Isi formulir di bawah ini dan kami akan segera menghubungi Anda.</p>

                                <form className="mt-6 space-y-4" onSubmit={(e: FormEvent) => e.preventDefault()}>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Lengkap</label>
                                        <input
                                            type="text"
                                            className="mt-1.5 w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:focus:border-emerald-400"
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-bold text-gray-900 dark:text-white">SDIT Al-Aziz</h3>
                                    <p className="text-xs text-gray-500 dark:text-gray-400">Sekolah Dasar Islam Terpadu</p>
                                </div>
                            </div>
...
function ArtIcon({ className }: { className?: string }) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 0 1-1.632 2.163l-1.32.377a1.803 1.803 0 1 1-.99-3.467l2.31-.66a2.25 2.25 0 0 0 1.632-2.163Zm0 0V4.846a2.25 2.25 0 0 0-1.632-2.163l-1.32-.377a1.803 1.803 0 1 0-.99 3.467l2.31.66A2.25 2.25 0 0 1 9 9Zm-8.25 6.75h.008v.008H.75v-.008Zm0-3h.008v.008H.75v-.008Z" />
        </svg>
    );
}
...
function MosqueIcon({ className }: { className?: string }) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1.5M12 4.5C9 4.5 6 7.5 6 10.5V21h12V10.5c0-3-3-6-6-6ZM6 21H3v-6a3 3 0 0 1 3-3m12 9h3v-6a3 3 0 0 0-3-3m-6-6V3m0 1.5c0-1 .5-1.5.5-1.5S12 2 12 3" />
        </svg>
    );
}
