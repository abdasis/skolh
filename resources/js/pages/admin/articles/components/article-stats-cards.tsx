import { CheckCircle, FileEdit, FileText, Image } from 'lucide-react';
...
const ArticleStatsCardsSkeleton = () => (
...
const ArticleStatsCards = ({ stats }: Props) => {
    if (!stats) {
