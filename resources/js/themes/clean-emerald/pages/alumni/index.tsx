                ...
                <div className="mx-auto mt-10 max-w-md">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-full border border-gray-200 bg-white py-2.5 pr-4 pl-10 text-sm text-gray-700 shadow-sm transition focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200"
                        />
                    </div>
                </div>
