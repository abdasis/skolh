...
const AdmissionRegisterPage = ({ period, customFields }: Props) => {
    ...
    const { data, setData, post, processing, errors, clearDraft, hasDraft } =
        useFormDraft<Record<string, string | number | null | File>>(draftKey, {
            ...
            ...Object.fromEntries(
                fields.map((f) => [`custom_fields.${f.id}`, '']),
            ),
        });
        ...
        <>
            ...
            <div className="mx-auto mt-[calc(1.75rem+3.75rem)] max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
                <PageHero
                    ...
                    description={`Tahun Ajaran ${period.academic_year} \u2022 ${period.start_date} s.d. ${period.end_date}`}
                />
                ...
                {hasDraft() && (
                    <div className="mb-2 flex items-center justify-between gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 dark:border-emerald-800 dark:bg-emerald-950/40">
                        <div className="flex items-center gap-2 text-sm text-emerald-700 dark:text-emerald-400">
                            ...
                            <span>
                                Draft ditemukan — formulir dilanjutkan dari sesi
                                sebelumnya.
                            </span>
                        </div>
                        <button
                ...
                >
                    <SectionToggle title="A. Data Pribadi" defaultOpen>
                        ...
                        <FormInput
                            ...
                            maxLength={3}
                            onChange={(e) =>
                                setData('address_rt', e.target.value)
                            }
                        ...
                        <FormInput
                            ...
                            maxLength={3}
                            onChange={(e) =>
                                setData('address_rw', e.target.value)
                            }
                        ...
                        <FormInput
                            ...
                            onChange={(e) =>
                                setData('address_village', e.target.value)
                            }
                        ...
                        <FormInput
                            ...
                            onChange={(e) =>
                                setData('address_district', e.target.value)
                            }
                        ...
                        <FormInput
                            ...
                            onChange={(e) =>
                                setData('address_province', e.target.value)
                            }
                    ...
                    <SectionToggle title="B. Data Orang Tua - Ayah">
                        ...
                        <FormInput
                            ...
                            maxLength={16}
                            onChange={(e) =>
                                setData('father_nik', e.target.value)
                            }
                        ...
                        <FormInput
                            ...
                            onChange={(e) =>
                                setData('father_birth_year', e.target.value)
                            }
                    ...
                    <SectionToggle title="C. Data Orang Tua - Ibu">
                        ...
                        <FormInput
                            ...
                            maxLength={16}
                            onChange={(e) =>
                                setData('mother_nik', e.target.value)
                            }
                        ...
                        <FormInput
                            ...
                            max={new Date().getFullYear()}
                            onChange={(e) =>
                                setData('mother_birth_year', e.target.value)
                            }
                    ...
                    <SectionToggle title="D. Data Wali (Opsional)">
                        ...
                        <FormInput
                            ...
                            onChange={(e) =>
                                setData('guardian_occupation', e.target.value)
                            }
                    ...
                    <SectionToggle title="E. Data Asal Sekolah (Opsional)">
                        <FormInput
                            ...
                            onChange={(e) =>
                                setData('previous_school_name', e.target.value)
                            }
                        ...
                        <FormInput
                            ...
                            maxLength={8}
                            onChange={(e) =>
                                setData('previous_school_npsn', e.target.value)
                            }
                    ...
                    <SectionToggle title="F. Dokumen" defaultOpen>
                        <FileField
                            ...
                            onChange={(file) =>
                                setData('registration_photo', file)
                            }
                        />
                        <FileField
                            ...
                            onChange={(file) =>
                                setData('registration_id_document', file)
                            }
                        />
                    </SectionToggle>
