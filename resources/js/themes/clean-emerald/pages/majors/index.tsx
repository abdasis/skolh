                    ...
                    <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {majors.map((major) => (
                            <Link
                                ...
                                className="group relative overflow-hidden rounded-2xl bg-emerald-600 text-white transition duration-300 hover:-translate-y-1 dark:bg-emerald-700"
                            >
                                {major.featured_image_url ? (
                                    ...
                                    <div className="relative flex h-44 w-full items-center justify-center bg-emerald-700 dark:bg-emerald-800">
                                ...
                                <div className="relative p-5">
                                    ...
                                    <p className="mt-2 line-clamp-3 text-xs text-emerald-100/80">
                                        {major.description}
                                    </p>
