                    ...
                    <div>
                        <div className="flex items-center gap-2.5">
                            {siteConfig?.identity.logo_url ? (
                                ...
                                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#006BFF] text-xs font-bold text-white">
                                        ...
                                        <ul className="space-y-2">
                                            {group.links.map((link) => (
                                                <li key={link.label}>
                                                    <a
                                                        href={link.href}
                                                        className="text-sm text-gray-400 transition hover:text-[#006BFF] dark:text-gray-500 dark:hover:text-[#3B8BFF]"
                                                    >
                                                        {link.label}
                                                    </a>
                                                </li>
