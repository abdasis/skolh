                ...
                <div className="mt-8 flex gap-10 lg:items-start">
                    <article className="min-w-0 flex-1">
                        {major.featured_image_url ? (
                            ...
                            <div className="relative mb-8 flex h-64 w-full items-center justify-center overflow-hidden rounded-2xl bg-blue-600 sm:h-80 lg:h-96 dark:bg-blue-700">
                                <GraduationCap className="h-24 w-24 text-white/70" />
                            </div>
                        )}

                        <div className="flex items-start gap-4">
                            <div className="inline-flex shrink-0 rounded-xl bg-blue-600 p-3 text-white">
                        ...
                        {major.content && (
                            <div
                                className="prose prose-blue dark:prose-invert mt-10 max-w-none"
                    ...
                    <aside className="hidden w-64 shrink-0 lg:block">
                        <div>
                            <span className="bg-blue-600 px-3 py-1.5 text-[11px] font-bold tracking-widest text-white uppercase dark:bg-blue-500">
                                Jurusan Lainnya
                            </span>
                            ...
                            <ul className="mt-4 space-y-4">
                                {others.map((item) => (
                                    <li key={item.id}>
                                        ...
                                        >
                                            <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-blue-50 text-blue-600 transition group-hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-400 dark:group-hover:bg-blue-900/50">
                                                <GraduationCap className="h-4 w-4" />
                                            </div>
                                            <div className="min-w-0">
                                                <p className="line-clamp-2 text-sm leading-snug font-medium text-gray-700 transition group-hover:text-blue-600 dark:text-gray-300 dark:group-hover:text-blue-400">
                                                    {item.title}
                                                </p>
