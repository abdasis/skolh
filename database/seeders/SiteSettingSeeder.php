...
class SiteSettingSeeder extends Seeder
{
    ...
    {
        SiteSetting::set('school_history', '<p>Sekolah Dasar Islam Terpadu Al-Aziz berdiri pada tahun 2008 atas prakarsa sekelompok tokoh masyarakat dan ulama di Bangkalan yang memiliki visi untuk menghadirkan lembaga pendidikan dasar berkualitas dengan landasan nilai-nilai Islam.</p><p>Pada awal pendiriannya, SDIT Al-Aziz hanya memiliki dua rombongan belajar dengan jumlah siswa sekitar 40 anak dan menempati gedung sederhana di kawasan pusat kota Bangkalan. Dengan dukungan penuh dari orang tua siswa dan masyarakat sekitar, sekolah terus berkembang dari tahun ke tahun.</p><p>Pada tahun 2012, SDIT Al-Aziz membangun gedung baru yang lebih representatif dan dilengkapi dengan fasilitas laboratorium komputer, perpustakaan, serta lapangan olahraga. Jumlah siswa pun terus meningkat hingga mencapai lebih dari 200 siswa pada periode tersebut.</p><p>Memasuki dekade kedua, sekolah memperkuat program unggulannya yang memadukan kurikulum nasional dengan pendidikan keislaman secara terpadu. Program tahfidz, pembiasaan shalat berjamaah, dan pembinaan akhlak menjadi identitas kuat yang membedakan SDIT Al-Aziz dengan sekolah dasar lainnya.</p><p>Hingga saat ini, SDIT Al-Aziz telah meluluskan lebih dari 500 alumni yang tersebar di berbagai jenjang pendidikan lanjutan, baik di lingkup lokal maupun nasional. Sekolah terus berkomitmen untuk memberikan pendidikan terbaik demi membentuk generasi yang beriman, berilmu, dan berakhlak mulia.</p>');
